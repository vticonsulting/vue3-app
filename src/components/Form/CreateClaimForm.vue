...
<template>
  <section>
    <o-steps v-model="currentStep" step-content-class="o-demo-form">
      <o-step-item step="1" label="Profile">
        <h2 class="o-demo__title">
          Fill your profile information
        </h2>
        <o-field :message="messages.name" :variant="messages.name ? 'danger' : ''">
          <o-dropdown v-model="currentMenu" aria-role="list">
            <o-button
              slot="trigger"
              slot-scope="{ active }"
              variant="primary"
          ...
          <o-input id="name" v-model="name" type="text" placeholder="Name" expanded />
        </o-field>

        <o-field label="Work information">
          <div class="o-demo-form__field-2-col">
            <o-input name="company" placeholder="Company" expanded />
            <o-input name="email" placeholder="Email" expanded />
          </div>
        </o-field>

        <o-field label="Address">
          <div class="o-demo-form__field-3-col">
            <o-input name="street" placeholder="Street" expanded />
            <o-input name="zip" placeholder="Zip Code" expanded />
            <o-input name="country" placeholder="Country" expanded />
          </div>
        </o-field>
        <o-field
        ...
        >
          <div class="o-demo-form__field-2-col">
            <o-checkbox v-model="privacy">
              Privacy Policy
            </o-checkbox>
            <o-checkbox v-model="terms">
