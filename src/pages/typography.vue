<template>
  <div class="relative flex flex-col justify-center min-h-screen overflow-hidden">
    <!-- <img
      src="/assets/img/francesca-tosolini-XcVm8mn7NUM-unsplash.jpg"
      alt=""
        ...
        <ul>
          <li>
            ...
            <p>
              ...
              separate list items to all make sense. Pretty tough honestly, you could make
              a strong argument that you just shouldn't write this way.
            </p>
          </li>
          <li>
