<template>
  ...
  <div class="px-6 mt-8">
    ...
    <label for="toggle-example" class="relative flex items-center mb-4 cursor-pointer">
      <input id="toggle-example" type="checkbox" class="sr-only">
      <div
    ...
    <label for="toggle-example-checked" class="relative flex items-center mb-4 cursor-pointer">
      <input id="toggle-example-checked" type="checkbox" class="sr-only" checked>
      <div
        class="h-6 bg-gray-200 border border-gray-200 rounded-full w-11 toggle-bg dark:bg-gray-700 dark:border-gray-600"
      />
    ...
    <label for="toggle-example-disabled" class="relative flex items-center mb-4 cursor-not-allowed">
      <input id="toggle-example-disabled" type="checkbox" class="sr-only" disabled>
      <div
        class="h-6 bg-gray-200 border border-gray-200 rounded-full w-11 toggle-bg dark:bg-gray-700 dark:border-gray-600"
      />
